...
public class Main {
    ...
    public static void main(String[] args) {
      //  Map<Long, Student> studentMap = new HashMap<>();
        Map<Long, Student> studentMap = new TreeMap<>();// sortuje
        //LinkHashset zachowuje kolejność
        //Hashset to jest worek
        //Linkhashmap zachowuje kolejnosc wstawiania
        ...
        System.out.println(studentMap.get(100400L)); //wyciaga z tego obiektu hashcode i hashcode jest kluczem
